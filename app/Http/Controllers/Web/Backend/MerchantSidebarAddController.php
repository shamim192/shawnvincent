...
class MerchantSidebarAddController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view("backend.layouts.sidebar-add.index");
    }
    ...
    {
        return view('backend.layouts.sidebar-add.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.merchant.sidebar.index')->with('success', 'Add created successfully');
    }

    /**
     * Display the specified resource.
     */
    public function show(SidebarAdd $merchant, $id)
    {
        $merchant = SidebarAdd::findOrFail($id);
        return view('backend.layouts.sidebar-add.edit', compact('merchant'));
    }

    /**
     * Show the form for editing the specified resource.
     */
    public function edit(SidebarAdd $merchant, $id)
    {
        $merchant = SidebarAdd::findOrFail($id);
        return view('backend.layouts.sidebar-add.edit', compact('merchant'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.merchant.sidebar.index');
    }
